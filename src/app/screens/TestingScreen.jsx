  ...
  return (
    <div style={{minHeight:"100vh",backgroundColor:T.white,fontFamily:T.sans,color:T.body}}>
      ...
      <section style={{
        ...
        <Image src="/images/testing.png" alt="Product Testing" fill style={{ objectFit: "cover", objectPosition: "center 40%" }} />
          ...
          <div className="overview-grid">
            <div className="reveal-left" ref={overviewRef}>
              ...
              <div style={{position:"relative",borderRadius:10,overflow:"hidden",height:220}}>
                <Image src="https://images.unsplash.com/photo-1576091160550-2173dba999ef?w=900&q=80&fit=crop" alt="Testing lab" fill style={{ objectFit: "cover", objectPosition: "center 40%" }} unoptimized />
        ...
        <div className="inner">
          <div style={{
            ...
            <div style={{position:"relative",minHeight:250,overflow:"hidden"}}>
              <Image src="/finalimages/faq10.jpg" alt="Testing FAQ" fill style={{ objectFit: "cover", objectPosition: "center 30%" }} />
            </div>
