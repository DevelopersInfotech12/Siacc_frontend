  ...
  useEffect(() => {
    ...
    (async () => {
      try {
        ...
        if (data.success && data.data) setBlog(data.data);
              ...
              {blog.related.map((article, i) => (
                ...
                >
                  ...
                  <div style={{ height: 172, overflow: "hidden", position: "relative" }}>
                    ...
                    <div style={{ position: "absolute", top: 12, left: 12 }}>
                      <span style={{
                        ...
                        background: article.tagBg || T.tealLight,
                        color: article.tagColor || T.teal,
                    ...
                    <div style={{ position: "absolute", bottom: 10, left: 14 }}>
                      <span style={{ fontFamily: T.sans, fontSize: 11, color: "rgba(255,255,255,0.85)", fontWeight: 500 }}>
                        {article.date}
                      </span>
                    </div>
                  ...
                  <div style={{ padding: "16px 18px 18px" }}>
                    <h3 style={{
                      fontFamily: T.poppins, fontSize: 14.5, color: T.slate,
                      fontWeight: 600, lineHeight: 1.45, margin: "0 0 12px",
                    }}>
                      {article.title}
                    </h3>
                  ...
                  {/* Bottom accent bar — visible on hover via CSS class trick using inline transition */}
                  <div style={{
                    position: "absolute", bottom: 0, left: 0, right: 0,
                    height: 3, background: `linear-gradient(to right, ${T.teal}, ${T.orange})`,
