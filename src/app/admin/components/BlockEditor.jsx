    ...
    <div>
      ...
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 20 }}>
        ...
        <div style={{ display: "flex", gap: 8 }}>
          <Btn variant="secondary" onClick={() => setShowAI(true)} style={{ background: "linear-gradient(135deg,#7C3AED,#1E88C8)", color: "#fff", border: "none" }}>✨ AI Generate</Btn>
